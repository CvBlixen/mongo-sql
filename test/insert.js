...
describe("Built-In Query Types", function() {
  describe("Type: insert", function() {
    it("should insert", function() {
      ...
      assert.deepEqual(query.values, ["Bob", "bob@bob.com"]);
    });
    ...
    it("should insert with a value from a subquery", function() {
      ...
      assert.deepEqual(query.values, ["Bob", 7]);
    });
    ...
    it("should do multi-insert", function() {
      ...
      assert.deepEqual(query.values, [
        query.original.values[0].name,
        query.original.values[0].email,
        query.original.values[1].name,
        query.original.values[1].email,
        query.original.values[2].name,
        query.original.values[2].email
      ]);
    });
    ...
    it("should skip undefined in insert", function() {
      ...
      assert.deepEqual(query.values, ["Bob"]);
    });
